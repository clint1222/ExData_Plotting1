...
plot(pwrConsump$Date, pwrConsump$Voltage, 
     type="l", 
     xlab="datetime", 
     ylab="Voltage")
...
legend("topright", 
       ...
       bty="n")
plot(pwrConsump$Date, pwrConsump$Global_reactive_power, 
     type="l", 
     xlab="datetime", 
